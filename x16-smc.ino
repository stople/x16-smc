...
void PowerOffSeq() {
  ...
  Keyboard.reset(PS2_DDR_DISABLED);           // Reset and deactivate pullup
  Mouse.reset(PS2_DDR_DISABLED);              // Reset and deactivate pullup
...
void PowerOnSeq() {
  ...
  Keyboard.reset(PS2_DDR_RECEIVE);            // Reset and activate pullup
  Mouse.reset(PS2_DDR_RECEIVE);               // Reset and activate pullup
